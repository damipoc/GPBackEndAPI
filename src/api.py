...
@app.route("/devices/<device>/telemetry", methods=["POST"])
def post_device_telemetry(device):
    ...
    #Testing purpose
    #Outputs the final data after its been validated in the POST page, uncomment and comment the other return if needed to use
    #return tele_valid_data_anom, 200
